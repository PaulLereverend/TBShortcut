...
@available(OSX 10.12.2, *)
extension TestViewController: NSTouchBarDelegate {
    ...
    func touchBar(_ touchBar: NSTouchBar, makeItemForIdentifier identifier: NSTouchBarItem.Identifier) -> NSTouchBarItem? {
        ...
        // You can setup a different NSTouchBar instance for popoverTouchBar and pressAndHoldTouchBar property
        // However, in that case, the chevron won't be shown. Here you just use the same NSTouchBar instance.
